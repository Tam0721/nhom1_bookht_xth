                ...
                <div id="kt_footer" class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
                    <div class="kt-container kt-container--fluid">
                        <div class="footer-filter-by-campus row">
                            <div class="column poly-logo"><img id="poly-logo"
                                    src="https://ap.poly.edu.vn/images/logo.png" alt="" width="250">
                                <h6 class="kt-widget1__title"><i class="fas fa-map-marker-alt"></i> <a
                                        class="kt-link address">
                                ...
                                <div class="campus-contact-content"><i class="fas fa-phone-alt"></i> <span>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    <li><a class="kt-link title">Đào tạo: daotaofpoly.hcm@fe.edu.vn</a>
                                                    </li>
                                                    <li><a class="kt-link title">Khảo thí: khaothi.fplhcm@fe.edu.vn</a>
                                                    </li>
                                                </ul>
                                            </li>
